...
- [Скачать постоянный Server Installer](https://github.com/prostoodin1/Cloud-storage/releases/download/v0.9.14/CloudStorage-Server-Installer-windows-x64.exe)
