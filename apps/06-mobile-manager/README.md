...
- [Скачать телефонный менеджер для Android](https://github.com/prostoodin1/Cloud-storage/releases/download/v0.9.8/CloudStorage-Mobile-Manager-0.9.8-android.apk)
- [Скачать iPhone/iPad Simulator](https://github.com/prostoodin1/Cloud-storage/releases/download/v0.9.8/CloudStorage-Mobile-Manager-0.9.8-apple-simulator.zip)
...
- [Скриншот iPhone](../../screenshots/CloudStorage-Mobile-manager-0.9.8-iPhone.png)
