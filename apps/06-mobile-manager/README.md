...
- [Скачать телефонный менеджер для Android](https://github.com/prostoodin1/Cloud-storage/releases/download/v0.9.5/CloudStorage-Mobile-Manager-0.9.5-android.apk)
- [Скачать iPhone/iPad Simulator](https://github.com/prostoodin1/Cloud-storage/releases/download/v0.9.5/CloudStorage-Mobile-Manager-0.9.5-apple-simulator.zip)
...
- [Скриншот iPhone](../../screenshots/CloudStorage-Mobile-manager-0.9.5-iPhone.png)
