...
ARTICLES = (
    ...
    KnowledgeArticle(
        ...
        "Нет. Текущая версия не открывает порты в интернет и не настраивает роутер. Удалённый "
        "доступ будет отдельной функцией после TLS, проверки личности сервера и дополнительной "
