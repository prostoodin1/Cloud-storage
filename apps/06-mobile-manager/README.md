...
Менеджер открывается в том же подписанном приложении только подтверждённому администратору. Опасные операции требуют пароль, биометрию при наличии и одноразовое серверное подтверждение.
