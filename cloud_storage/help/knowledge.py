...
ARTICLES = (
    ...
    KnowledgeArticle(
        ...
        "Пока нет. Alpha 0.5 начала этап надёжности, но не открывает порты в интернет и не "
        "настраивает роутер. Локальный TLS уже работает; внешний доступ будет включён отдельным "
        "срезом после модели доверия, отзыва удалённого доступа и дополнительной защиты администратора.",
