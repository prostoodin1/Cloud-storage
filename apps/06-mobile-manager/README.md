...
- [Скачать телефонный менеджер для Android](https://github.com/prostoodin1/Cloud-storage/releases/download/v0.9.9/CloudStorage-Mobile-Manager-0.9.9-android.apk)
- [Скачать iPhone/iPad Simulator](https://github.com/prostoodin1/Cloud-storage/releases/download/v0.9.9/CloudStorage-Mobile-Manager-0.9.9-apple-simulator.zip)
